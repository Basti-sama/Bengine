...
class Bengine_Page_RocketAttack extends Bengine_Page_Abstract
{
	/**
	 * Target id.
	 *
	...
	{
		if(Bengine::getResearch(14) + 1 <= count(Bengine::getEH()->getOwnFleetEvents()))
		{
	 ...
	 * Index action.
	 *
	 * @return Bengine_Page_RocketAttack
	 */
	protected function indexAction()
	{
		if($this->t)
		{
			...
			$diff = abs($this->t["system"] - Bengine::getPlanet()->getData("system"));
	...
	protected function sendRockets($quantity, $primaryTarget)
	{
		...
		// Check max. range
		else if($this->t["galaxy"] == Bengine::getPlanet()->getData("galaxy") && Bengine::getRocketRange() >= $diff)
		{
