...
class Bengine_Game_EventHandler_Handler_Fleet_Holding extends Bengine_Game_EventHandler_Handler_Fleet_Abstract
{
	/**
	 * Executes the event.
	 *
	 ...
	 * @param array $data
	 *
	 * @return Bengine_Game_EventHandler_Handler_Fleet_Holding
	 */
