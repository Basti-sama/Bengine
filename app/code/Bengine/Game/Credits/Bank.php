...
class Bengine_Game_Credits_Bank
{
	/**
	 * Instance of the bengine_bank.
	 *
	 * @var Bengine_Game_Bank
	 */
	 ...
	 *
	 * @return Bengine_Game_Bank	An instance of the bengine_bank
	 */
	public static function getInstance()
	{
		if(self::$instance == null)
		{
			self::$instance = new Bengine_Game_Credits_Bank();
		}
	 ...
	 *
	 * @return Bengine_Game_Bank_Account
	 */
	public function getBankAccount($userid)
	{
		if(!array_key_exists($userid, $this->bank_accounts))
		{
			$this->bank_accounts[$userid] = new Bengine_Game_Credits_BankAccount($userid);
