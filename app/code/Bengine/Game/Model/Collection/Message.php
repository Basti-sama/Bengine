...
class Bengine_Game_Model_Collection_Message extends Recipe_Model_Collection_Abstract
{
	/**
	 * Adds a time order.
	 *
	 * @param string
	 *
	 * @return Bengine_Game_Model_Collection_Message
	 */
	...
	{
		if($receiver instanceof Bengine_Game_Model_User)
		{
	...
	{
		if($sender instanceof Bengine_Game_Model_User)
		{
			$sender = $sender->getId();
		}
