...
abstract class Bengine_Game_Profile_Field_Abstract
{
	/**
	 ...
	 *
	 * @var Bengine_Game_Model_Profile
	 */
	 ...
	 */
	public function __construct(Bengine_Game_Model_Profile $model = null)
	{
		if(!is_null($model))
		{
			$this->setModel($model);
	 ...
	 *
	 * @param Bengine_Game_Model_Profile
	 *
	 * @return Bengine_Game_Profile_Field_Abstract
	 */
	public function setModel(Bengine_Game_Model_Profile $model)
	{
		$this->model = $model;
		return $this;
	}
