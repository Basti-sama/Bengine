...
class Bengine_Model_Event extends Recipe_Model_Abstract
{
	/**
	 * (non-PHPdoc)
	 * @see lib/Object#init()
	...
	{
		return Bengine_EventHandler_Static::getHandlerObject($this->getMode(), $this);
	}
	...
	public function getPlanet()
	{
		...
		{
			$this->set("planet", Bengine::getModel("planet")->load($this->getPlanetid()));
		}
	...
	public function getDestinationPlanet()
	{
		...
		{
			$this->set("destination_planet", Bengine::getModel("planet")->load($this->getDestination()));
		}
	...
	public function getDestinationUser()
	{
		...
		{
			$this->set("destination_user", Bengine::getModel("user")->load($this->getDestinationUserId()));
		}
	...
	{
		return Bengine::getMissionName($this->getMode());
	}
	...
	{
		return Bengine::getMissionName($this->getOrgMode());
	}

	/**
	 * (non-PHPdoc)
	 * @see app/code/Bengine/Model/Bengine_Model_Abstract#_beforeSave()
	 * TODO
	 */
	...
	/**
	 * (non-PHPdoc)
	 * @see app/code/Bengine/Model/Bengine_Model_Abstract#_afterSave()
	 * TODO
	 */
