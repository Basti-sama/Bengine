...
class Bengine_Model_Collection_Event extends Recipe_Model_Collection_Abstract
{
	/**
	 ...
	 *
	 * @param integer|Bengine_Model_User	The user to select
	 *
	 * @return Bengine_Model_Collection_Event
	 */
	public function addUserFilter($user)
	{
		if($user instanceof Bengine_Model_User)
		{
			$user = $user->getId();
		}
	 ...
	 *
	 * @param integer|Bengine_Model_Event
	 *
	 * @return Bengine_Model_Collection_Event
	 */
	public function addParentIdFilter($parent)
	{
		if($parent instanceof Bengine_Model_Event)
		{
			$parent = $parent->getId();
		}
