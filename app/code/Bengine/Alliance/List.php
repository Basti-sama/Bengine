...
class Bengine_Alliance_List implements IteratorAggregate
{
	/**
	...
	{
		$this->list = new Map();
		$this->relation = new Bengine_User_Relation(Core::getUser()->get("userid"), Core::getUser()->get("aid"));
		if(is_array($list))
		{
