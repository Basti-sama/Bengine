...
class Bengine_EventHandler_Handler_Fleet_Attack extends Bengine_EventHandler_Handler_Fleet_Abstract
{
	/**
	 * (non-PHPdoc)
	...
	protected function _execute(Bengine_Model_Event $event, array $data)
	{
		...
		$assault = new Bengine_Assault($event["destination"], $event["destination_user_id"]);
	...
	protected function _checkShips()
	{
		...
		$espProbeId = Bengine_EventHandler_Handler_Fleet_Espionage::ESPIONAGE_PROBE_ID;
