...
class Bengine_Credits_BankAccount
{
	/**
	...
	public function addCredits($credits, $taxes = true, $message = false)
	{
		...
		if($message !== false)
		{
			...
			$msg = new Bengine_AutoMsg(201, $this->userid, TIME, $messageData);
		}
		return true;
	}
	 ...
	 * @param string
	 *
	 * @return Bengine_Credits_BankAccount
	 */
	public function addTax($tax)
	{
		if(!array_key_exists($tax, $this->taxes))
		{
			$tax_name = "Bengine_Credits_Tax_".$tax;
