...
abstract class Bengine_MessageFolder_Abstract
{
	/**
	 * Empty constructor.
	 */
	 ...
	 *
	 * @return Bengine_Model_Message
	 */
	public function formatMessage(Bengine_Model_Message $message, $isFeed = false, $replace = false)
	{
		if($replace)
	 ...
	 * @param Bengine_Model_Message	Message model
	 *
	 * @return Bengine_MessageFolder_Abstract
	 */
	protected function _formatFeed(Bengine_Model_Message $message)
	{
	 ...
	 * @return Bengine_MessageFolder_Abstract
	 */
	abstract protected function _format(Bengine_Model_Message $message);
}