...
class Bengine_MessageFolder_Combat extends Bengine_MessageFolder_Abstract
{
	/**
	 * Formats the message.
	 *
	 ...
	 *
	 * @return Bengine_MessageFolder_Combat
	 */
	protected function _format(Bengine_Model_Message $message)
	{
		...
		$assault = Bengine::getModel("assault")->load((int) $message->get("message"));
	...
	protected function _formatFeed(Bengine_Model_Message $message)
	{
		...
		$assault = Bengine::getModel("assault")->load($assaultId);
