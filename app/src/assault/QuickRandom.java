 ...
 */
public
class QuickRandom implements java.io.Serializable {
    /** use serialVersionUID from JDK 1.1 for interoperability */
    static final long serialVersionUID = 5239872398432098744L;
     ...
     */
    public QuickRandom() { this(System.currentTimeMillis()); }
    ...
    synchronized public double nextGaussian() {
    	...
    	double multiplier_ = Math.sqrt(-2 * Math.log(s)/s);
    	this.nextNextGaussian = v2 * multiplier_;
