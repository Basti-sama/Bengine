...
('1', '15', 'ESP_REPORT_RESOURCE_HEADLINE_ALIEN', 'Ressourcen auf {@espPlanetName} {@espPlanetCoords}');
...
('GALAXY_VIEW_CONSUMPTION', '10', 'integer', 'Consumption cost per galaxy view (except for home solar system) in hydrogen.', '', 5, 1, 0);
...
UPDATE `bengine_phrases` SET `content` = 'Angriffssperre aktiv' WHERE `title` = 'ATTACKING_STOPPAGE_ENABLED' AND `languageid` = 1;
