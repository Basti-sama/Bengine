<?php
class Admin_Controller_Cronjob extends Admin_Controller_Abstract
{
	...
	protected function indexAction()
	{
		...
		while($row = Core::getDB()->fetch($result))
		{
			...
			$tabs[$id]["delete"] = Link::get("cronjob/delete/".$id, Core::getLanguage()->getItem("Delete"));
			$tabs[$id]["exec"] = Link::get("cronjob/execute/".$id, Core::getLanguage()->getItem("Execute"));
			$tabs[$id]["edit"] = Link::get("cronjob/edit/".$id, Core::getLanguage()->getItem("Edit"));
			$tabs[$id]["active"] = ($row["active"]) ? Link::get("cronjob/disable/".$id, "<span class=\"green\">On</span>", Core::getLanguage()->getItem("Disable")) : Link::get("cronjob/enable/".$id, "<span class=\"red\">Off</span>", Core::getLanguage()->getItem("Enable"));
		}
